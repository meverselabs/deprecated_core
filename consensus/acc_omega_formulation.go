...
func init() {
	data.RegisterAccount("consensus.OmegaFormulationAccount", func(t account.Type) account.Account {
		return &OmegaFormulationAccount{
			Base: account.Base{
				Type_:    t,
...
// OmegaFormulationAccount is a consensus.OmegaFormulationAccount
// It is used to indentify formulator
type OmegaFormulationAccount struct {
	account.Base
...
func (acc *OmegaFormulationAccount) Clone() account.Account {
	return &OmegaFormulationAccount{
		Base: account.Base{
			Type_:    acc.Type_,
...
func (acc *OmegaFormulationAccount) WriteTo(w io.Writer) (int64, error) {
	var wrote int64
...
func (acc *OmegaFormulationAccount) ReadFrom(r io.Reader) (int64, error) {
	var read int64
...
func (acc *OmegaFormulationAccount) MarshalJSON() ([]byte, error) {
